    ...
    <html lang="en">
      <body className="bg-white dark:bg-gray-900 font-sans">
        <div className="min-h-screen w-full bg-[#020617] relative">
          ...
          {/* Main Content */}
          <ClientNav />
          <main className="pt-4 min-h-[90vh] relative z-10">{children}</main>
          {/* Footer with social links */}
          <footer className="w-full flex flex-col items-center gap-2 mt-auto mb-2 text-gray-400 text-xs z-20 relative">
            <div className="flex gap-5 mb-1">
              <a href="https://github.com/sarabjeet" target="_blank" rel="noopener noreferrer" aria-label="GitHub" className="hover:text-white transition group">
              ...
              <a href="https://linkedin.com/in/sarabjeet" target="_blank" rel="noopener noreferrer" aria-label="LinkedIn" className="hover:text-white transition group">
              ...
              <a href="https://twitter.com/sarabjeet" target="_blank" rel="noopener noreferrer" aria-label="Twitter" className="hover:text-white transition group">
